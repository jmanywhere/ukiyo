...
const Footer = () => {
  return (
    <footer className="border-t-[1px] border-light-grey bg-grey-blue pt-16 pb-8 w-full flex flex-col items-center">
      <div className="max-w-[1440px]  flex flex-col items-center w-full">
        <div className="w-full flex flex-col items-center xl:flex-row xl:justify-center xl:items-start xl:px-6">
          <div className="flex flex-col md:flex-row items-center  md:items-start w-full pb-5 md:px-8  xl:pl-24 max-w-[1200px] ">
          ...
          <div className="flex flex-col items-center rounded-full w-full lg:max-w-[500px] xl:max-w-[300px] py-9 xl:items-start xl:py-0 xl:px-10">
            <div className="py-3 xl:py-0">
              <h2 className="text-light-orange font-medium pb-3">
                Social Links
              </h2>
        ...
        <div className="w-full px-6 flex flex-col items-center">
          ...
          <p className="text-[12.61px] font-normal">
            Copyright © 2023 ukiyo. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
